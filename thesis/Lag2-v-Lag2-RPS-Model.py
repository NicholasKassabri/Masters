...
def run_single_game(num_iterations):
    ...
    agent1_working_memory = {
        'focus_buffer': {'state': 'start'},
        'lag_buffer': {'lag2': 'rock', 'lag1': 'paper', 'lag0': 'unknown'}
    }
    ...
    def recall_agent1_move(memories):
        ...
        lag2 = memories['agent1_working_memory']['lag_buffer']['lag2']
    ...
    def agent1_checks_agent2_move(memories):
        ...
        memories['agent1_working_memory']['lag_buffer']['lag2'] = lag1
    ...
    ps.run_cycles(memories, AllProductionSystems, DelayResetValues, cycles=16000, millisecpercycle=10)
